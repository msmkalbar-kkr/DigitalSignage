        ...
        <div class="flex flex-col gap-6 w-full h-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="flex flex-col">
                    ...
                    <x-input id="judul" name="judul" class="p-2 w-full bg" value="{{ $dataAwal->judul }}" />
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <!-- Row 1 -->
                <div class="flex flex-col">
                    <x-form.date-picker name="tanggal" label="Tanggal" id="tgl"
                        defaultDate="{{ $dataAwal->tanggal ?? '' }}" placeholder="Pilih tanggal" />
                </div>
                <div class="flex flex-col">
                    ...
                    <x-form.time-picker id="waktu" name="waktu" value="{{ $dataAwal->waktu ?? '' }}" />
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="flex flex-col">
                    ...
                    <x-input id="tempat" name="tempat" value="{{ $dataAwal->tempat }}" class="p-2 w-full" />
                </div>

                <div class="flex flex-col">
                    <label for="agenda" class="mb-1 font-medium text-gray-700">Agenda</label>
                    <x-input id="agenda" name="agenda" value="{{ $dataAwal->agenda }}" class="p-2 w-full bg" />
                    <x-input id="id" name="id" hidden value="{{ $dataAwal->id }}" class="p-2 w-full bg" />
                </div>
            </div>
            ...
            <div class="flex flex-col">
                ...
                <textarea id="keterangan" placeholder="Masukkan keterangan" type="text" rows="6"
                    ...
                    dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30">{{ $dataAwal->keterangan }}</textarea>
...
@push('scripts')
    @include('admin.master.pengumuman.js.edit')
@endpush
