...
@section('content')
    <x-common.page-breadcrumb pageTitle="Ulang Tahun" />
    <div
        ...
        <div id="tambah" class="flex justify-end w-full pb-8">
            <x-button class="bg-[#364878]" onclick="window.location='{{ route('admin.pengumuman.create') }}'">
                Tambah
            </x-button>
...
@endsection
@push('scripts')
    @include('admin.master.pengumuman.js.index')
@endpush
