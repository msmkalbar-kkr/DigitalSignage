<button x-data="{ theme: localStorage.getItem('theme') || 'light' }" x-init="if (theme === 'dark') {
    ...
    <!-- Dark Icon -->
    <svg x-show="theme === 'dark'" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20" width="20"
        height="20">
    ...
    <!-- Light Icon -->
    <svg x-show="theme === 'light'" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20" width="20"
        height="20">
        <path fill="currentColor"
