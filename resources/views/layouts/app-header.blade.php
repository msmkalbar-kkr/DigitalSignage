    ...
    <div class="flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
        <div
            ...
            <a href="/" class="xl:hidden">
                <img class="dark:hidden w-12 h-auto" src="{{ asset('images/Lambang_Kabupaten_Kubu_Raya2.png') }}"
                    alt="Logo" />
                <img class="hidden dark:block w-12 h-auto" src="{{ asset('images/Lambang_Kabupaten_Kubu_Raya2.png') }}"
                    alt="Logo" />
            </a>
