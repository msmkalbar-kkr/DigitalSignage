(function ($) {
    ...
    if ($("#visit-sale-chart").length) {
        ...
        var gradientStrokeBlue = graphGradient2.createLinearGradient(
            0,
            0,
            0,
            360
        ...
        var gradientStrokeRed = graphGradient3.createLinearGradient(
            0,
            0,
            0,
            300
    ...
    if ($("#traffic-chart").length) {
        ...
        var gradientStrokeBlue = graphGradient1.createLinearGradient(
            0,
            0,
            0,
            181
        ...
        var gradientStrokeRed = graphGradient2.createLinearGradient(
            0,
            0,
            0,
            50
        ...
        var gradientStrokeGreen = graphGradient3.createLinearGradient(
            0,
            0,
            0,
            300
